package com.liberties.iveagh.dbsgameofthronefragmentsdynamic;
...
public class GotFamilyViewerActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_got_family_viewer);
...
//import android.os.Bundle;
//
//public class GotFamilyViewerActivity extends AppCompatActivity {
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
